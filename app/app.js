...
app.controller('editCtrl', function ($scope, $rootScope, $location, $routeParams, services, customer) {
    ...
    $rootScope.title = (customerID > 0) ? 'Edit Entity' : 'Add Entity';
    $scope.buttonText = (customerID > 0) ? 'Update Entity' : 'Add New Entity';
      ...
      $scope.deleteCustomer = function(customer) {
        $location.path('/');
        if(confirm("Are you sure to delete entity number: "+$scope.customer._id)==true)
